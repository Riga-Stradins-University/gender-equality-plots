...
const employeesByGroup = {
          all_staff: { 
            ...
            y: [72,73,73,72], 
            total: [1589,1637,1641,2145], 
            },
          research: {
            x: [2022,2023,2024,2025], 
            y: [71,67,68,69], 
            total: [199,180,175,166]
            },
          academic: {
            x: [2022,2023,2024,2025], 
            y: [68,68,67,69], 
            total: [558,620,556,765], 
            },
          managers: {
            x: [2022,2023,2024,2025], 
            y: [71,73,72,67], 
...
const payByGroup = {
        managers: {x: [2022,2023,2024,2025], 
             female: [1333.63,1422.71,1662.41,2668.00], 
             male: [1337.33,1432.83,1668.55,2690.00], 
             name: "Managers" }
        };
